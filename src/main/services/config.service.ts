...
export function getConfig(): AppConfig {
    ...
    return {
        ...
        transcriptionPrompt: userConfig.transcriptionPrompt !== undefined ? userConfig.transcriptionPrompt : (process.env.OPENAI_TRANSCRIPTION_PROMPT || 'This is a technical interview conducted in English. Please transcribe the speech in Russian, but preserve English programming and technical terms exactly as they are (e.g. Redis, Postgres, Celery, HTTP, API, and etc.).'),
