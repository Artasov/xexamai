...
function AuthenticatedApp() {
  ...
  return (
    <div className="app-grid disable-tap-select relative fc h-screen min-w-[330px] text-gray-100">
      ...
      <header className="app-header frbc py-2 pl-2 pr-[10px] text-gray-100 drag-region">
        <div className="app-header__identity frsc gap-3">
          ...
          <h1 className="app-header__title text-lg font-semibold">xexamai</h1>
          <div
      ...
      <main className="flex flex-1 flex-col overflow-auto px-4 pb-4 pt-1">
        ...
        <div
          ...
          className="content-area flex flex-col gap-4 overflow-auto"
        ...
        <div
          ...
          className="content-area flex flex-col overflow-auto"
      ...
      <footer
        className="pointer-events-none absolute bottom-px left-1 flex items-end text-[9px] font-light opacity-40"
      ...
      {historyOpen ? (
        <HistoryDrawer open onClose={() => setHistoryOpen(false)} />
      ) : null}
      <WelcomeModal />
      {answerFontSizeNotice !== null ? (
        <div
          className="font-size-notification"
          role="status"
          aria-live="polite"
        >
...
function AppContent() {
  ...
  if (status === "initializing" || status === "checking") {
    return (
      <LoadingScreen
        message={status === "checking" ? "Restoring session…" : "Launching…"}
      />
    );
  }
